...
import { createPresentation, getPresentation } from "../../../api/presentation";
const Presentacion = ({ datoss, update, sinDatos }) => {
  ...
  return (
    <div className="w-[23.3%] h-auto rounded-[10px] sombra flex-shrink-0 bg-white flex flex-col py-4 my-2">
      <div className="w-full flex items-center mb-4">
        <p className="h3 negro w-[80%] ml-[5%]">Presentacion </p>
        ...
        <table className="w-[95%] mx-auto">
          <thead className="bg-white sticky top-0 z-10 ">
            <tr className="border-b sticky border-green-500 ">
              <th className="gris-urbano text-start px-2">Presentación</th>
