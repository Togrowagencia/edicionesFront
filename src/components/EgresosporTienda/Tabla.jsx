            ...
            <table className='w-[1475px] mx-[1%] my-[2%] border-collapse'>
                ...
                <thead>
                    <tr className='border-b border-grey-500 h-[10%]'>
                        ...
                        <th className='gris-urbano textos text-left'>Clasificación</th>
                        <th className='gris-urbano textos text-left'>Costo de compra</th>
                        <th className='gris-urbano textos text-left'>Inducción</th>
                        <th className='gris-urbano textos text-left'>Proveedor</th>
                        <th className='gris-urbano textos text-left'>Cantidad propia</th>
                        <th className='gris-urbano textos text-left'>Cantidad en consignación</th>
                        <th className='gris-urbano textos text-left'>Cantidad total</th>
                    </tr>
                </thead>
                {/* Filas de datos */}
                <tbody>
