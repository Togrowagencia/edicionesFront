  ...
  return (
    <div className="w-full h-[10%] flex items-center px-4">
      ...
      <div className="relative w-[350px] ml-[1%]">
        ...
        />
        <label
          htmlFor="puntodeventa"
          className={`absolute negro h4 cursor-text bg-white px-1 transition-all transform origin-left ${puntodeventa
        ...
        <img
          ...
          alt=""
          className={`absolute right-3 top-1/2 -translate-y-1/2 transition-all transform ${puntodeventa ? "rotate-180" : ""
