...
const Header = () => {
  ...
  return (
    ...
    <div className='w-full h-[10%] flex items-center gap-2 justify-start px-4 -ml-[1%]'>
          ...
          <div className='w-[15%] bg-white border border-[#000] rounded-[10px] px-4 flex gap-4 items-center h-[50%] ml-[1%] '>
              <img src="/svg/popup-ao/ISBN.svg" alt=""/>
              <input type="text" placeholder='ISBN' className='custom-datepicker h4 custom-input'/>
          </div>

          <div className='w-[20%] bg-white border border-[#000] rounded-[10px] px-4 flex gap-4 items-center h-[50%] ml-[1%] '>
