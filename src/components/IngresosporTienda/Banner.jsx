...
function Banner() {
    ...
    return (
        <div className="w-[100%] h-[100%] bg-cover bg-[#00733C] relative flex items-center bg-[url('/images/banneregresos.png')] bg-center rounded-[24px] px-8 py-6 my-4">
            <div className="relative text-left">
                ...
                <div className="bg-white w-[90%] rounded-[5px] flex gap-2 py-1 px-2 items-center my-3">
                    ...
                    <div className="flex justify-end w-[20%]">
                        <p className="bg-[#00733C] rounded-[5px] blanco px-2 ">+74.12%</p>
                    </div>
                </div>
            </div>
        </div>
