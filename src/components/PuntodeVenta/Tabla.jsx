...
const Tabla = () => {
  ...
  return (
    <>
        ...
        <tbody>
          {currentItems.map((item, index) => (
            <tr key={index} className=" rounded bg ">
              ...
              <p className="bg-green-700 rounded blanco textos px-2 py-2 my-1">
                Añadir
              </p>
            </tr>
          ))}
      ...
      <button className="flex justify-end items-end w-[99%]">
        <p className="bg-green-700 rounded blanco texto px-2">Pago credito</p>
      </button>
    </>
  );
};
