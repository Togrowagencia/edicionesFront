  ...
  import { createClasification,getClassification } from "../../../api/clasification";
...
import { createGender, getGenders } from "../../../api/genders";
  ...
  const PopupAO = ({
    ...
    const handleSubmit = async () => {
      ...
      if (String(inputValues.proveedor).trim() === ""||String(inputValues.isbn).trim() === "") {
        return new Notify({
      ...
      await createEntitiesIfNotExist({
        ...
        existingList: datos.Classification,
        createFn: createClasification,
        reload: reload,
